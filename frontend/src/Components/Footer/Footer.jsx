      ...
      <div className="container-fluid bg-dark text-secondary mt-5 pt-5">
        <div className="row px-xl-5 pt-5">
          <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            ...
            <p className="mb-2"><i className="fa fa-map-marker-alt text-primary mr-3"></i>Behind T B Hospital, Jaganath Budhwari, Maskasath, Itwari , Nagpur-440002</p>
            ...
            <div className="row">
              ...
              <div className="col-md-4 mb-5">
                ...
                <div className="d-flex flex-column justify-content-start">
                  ...
                  <a className="text-secondary mb-2" href="#"><i className="fa fa-angle-right mr-2"></i>Shopping Cart</a>
                  <a className="text-secondary mb-2" href="#"><i className="fa fa-angle-right mr-2"></i>Checkout</a>
                  <Link to="/terms" className="text-secondary" href="#"><i className="fa fa-angle-right mr-2"></i>Terms & Conditions</Link>
                </div>
              </div>
              <div className="col-md-4 mb-5">
        ...
        <div className="row border-top mx-xl-5 py-4" style={{ borderColor: 'rgba(256, 256, 256, .1) !important' }}>
          <div className="col-md-6 px-xl-0">
            <p className="mb-md-0 text-center text-md-left text-secondary">
              ...
              by
              <a className="text-primary" href="https://icieico.in"> ICEICO Technologies Pvt Ltd.</a>
            </p>
          </div>
